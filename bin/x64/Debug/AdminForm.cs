...
#region Default Instance
		...
		public void DataGridView1_CellContentClick(System.Object sender, System.Windows.Forms.DataGridViewCellEventArgs e)
		{
			...
			if (j == 0)
			{
				...
				txtBank.Text = Convert.ToString((DataGridView1.Rows[i].Cells[j + 11].Value));
        ...
        private void btnupdate_Click_1(object sender, EventArgs e)
        {
			...
			sql = "UPDATE tblinfo SET account_no=\'" + txtAcctNo.Text + "\',pin_code=\'" + txtPincode.Text + "\',Firstname=\'" + txtfnme.Text + "\',Lastname=\'" + txtlnme.Text + "\',Address=\'" + txtaddr.Text + "\',Contact_no=\'" + txtcontact.Text + "\',Gender=\'" + cbGender.Text + "\',Bank=\'" + txtBank.Text + "\'where Firstname=\'" + lblhide.Text + "\'";
			cmd.CommandText = sql;
			cmd.Connection = con;
			cmd.ExecuteNonQuery();
			cmd.Dispose();
			MessageBox.Show("User is updated sucessfully.....");
        ...
        private void btnblock_Click_1(object sender, EventArgs e)
        {
			...
			cmd.ExecuteNonQuery();
			cmd.Dispose();
			MessageBox.Show("User is Blocked Successfully");

			con.Close();
			Button5_Click(sender, e);
		}

        private void btnunblock_Click_1(object sender, EventArgs e)
        {
			con.Open();
			...
			cmd.ExecuteNonQuery();
			cmd.Dispose();
			MessageBox.Show("User is unblocked sucessfully...");
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
			...
			sql = "DELETE FROM tblinfo Where Firstname =\'" + txtfnme.Text + "\'";
			cmd.CommandText = sql;
			cmd.Connection = con;
			cmd.ExecuteNonQuery();
			cmd.Dispose();
